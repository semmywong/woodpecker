/*
 * @Author: Semmy Wong
 * @Date: 2023-06-08 12:46:55
 * @LastEditors: Semmy Wong
 * @LastEditTime: 2023-06-08 12:53:36
 * @Description: 描述
 */
...
export class Localize {
  ...
  private options: { locale: string } | undefined;
  ...
  private resolveLanguagePack() {
    ...
    const rootPath = extensions.getExtension('SemmyWong.woodpecker')!.extensionPath;
